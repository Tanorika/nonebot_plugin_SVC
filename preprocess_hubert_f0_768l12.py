...
hps = utils.get_hparams_from_file("configs/config_768l12.json")
...
def process_one(filename, hmodel):
    ...
    if not os.path.exists(soft_path):
        ...
        c = utils.get_hubert_content_layer12(hmodel, wav_16k_tensor=wav16k)
...
def process_batch(filenames):
    print("Loading hubert for content... (Using Vec768-Layer12)")
